...
def morra_golosa():
    ...
    if punti_totali > numero_partite / 2:
        print(f"Hai totalizzato {punti_totali} punti su {numero_partite}. Congratulazioni, hai vinto!")
    elif punti_totali == numero_partite / 2:
        print(f"Hai totalizzato {punti_totali} punti su {numero_partite}. Hai pareggiato!")
    else:
        print(f"Hai totalizzato {punti_totali} punti su {numero_partite}. Hai perso!")
    print(f"Grazie per aver partecipato, buon appetito!")
